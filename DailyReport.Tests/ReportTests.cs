...
namespace DailyReport.Tests
{
    ...
    public class ReportTests
    {
        ...
        [TestMethod] public void Validate_リンクのみ_エラー()
        {
        ...
        [TestMethod] public void Validate_無効URL_エラー()
        {
        ...
        [TestMethod] public void Validate_空白入力_エラー()
        {
            var r = Valid();
            r.Name = "  ";
        ...
        [TestMethod] public void Generate_空行のみ_なし表示()
        {
        ...
        [TestMethod] public void Generate_制御文字_エスケープ()
        {
        ...
        [TestMethod] public void GetDefaultFileName_不正文字_置換()
        {
        ...
        [TestMethod] public void Save_正常値_BOMなし()
        {
        ...
        [TestMethod] public void Save_キャンセル_ファイル保存なし()
        {
        ...
        [TestMethod] public void Save_正常値_ファイル保存成功()
        {
            var file = new FileFake();
        ...
        [TestMethod] public void Save_書き込み失敗_エラー表示と入力保持()
        {
